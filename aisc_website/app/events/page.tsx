...
export default function EventsPage() {
  ...
  return (
    <>
      <Navbar />
      <section className="relative min-h-screen flex flex-col-reverse md:flex-row justify-between px-4 py-16 md:py-20 text-gray-800 dark:text-white">
        <div className="flex flex-col gap-6 md:flex-row w-full justify-between items-start md:items-end">
          <h1 className="font-semibold text-3xl md:text-5xl font-[var(--font-bai-jamjuree)] leading-snug max-w-4xl text-center md:text-left">
          ...
          <p className="text-center md:text-right text-base md:text-lg text-black dark:text-white/70 italic font-[var(--font-bai-jamjuree)]">
            — Fei-Fei Li
          </p>
        </div>
        <p className="mt-6 md:mt-10 text-base md:text-lg italic text-black dark:text-white/80 max-w-2xl text-center md:text-right self-center md:self-end font-[var(--font-bai-jamjuree)]">
