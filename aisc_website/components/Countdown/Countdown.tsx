...
const Countdown = () => {
    ...
    // countdown container
      <div className="flex flex-col items-center justify-center w-full h-full gap-8 sm:gap-8 mt-20 mb-24">
        <span className="text-blue-300 text-2xl sm:text-3xl font-semibold text-center tracking-widest px-2">
            Come See Us At
        </span> 
        <span className=" text-blue-300 text-2xl sm:text-6xl font-black text-center tracking-widest px-2">
          {event[0].title}
        </span>
        <div className="flex justify-center gap-3 sm:gap-8">
          ...
          <div className="flex flex-col gap-5 relative">
            ...
            <span className="text-blue-300 text-xs sm:text-4xl text-center capitalize">
              {days == 1 ? "Day" : "Days"}
            </span>
          </div>
          <div className="flex flex-col gap-5 relative">
            ...
            <span className="text-blue-300 text-xs sm:text-4xl text-center font-medium">
              {hours == 1 ? "Hour" : "Hours"}
            </span>
          </div>
          <div className="flex flex-col gap-5 relative">
